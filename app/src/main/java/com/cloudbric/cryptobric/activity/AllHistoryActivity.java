...
import com.cloudbric.cryptobric.adapter.AllHistoryListAdapter;
...
public class AllHistoryActivity extends AppCompatActivity implements PackageEventListener {
    private static final String TAG = "AllHistoryActivity";
    ...
    AllHistoryListAdapter mHistorytAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mHistorytAdapter = new AllHistoryListAdapter(mContext, scannedAndInstalledList, mDetectedCount);
    ...
    private class PackageEventReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.PACKAGE_REMOVED".equals(intent.getAction())) {
                ...
                // update Crypto detected count
                CommonUtil.updateCryptoScanDetectedCount(context);
...
//            frameTopbar.setBackgroundResource(R.drawable.main_bacground_top_green_color);
        ...
        ScanDetected.setAllScanDetectedCount(mContext, mDetectedCount);
    ...
    private List<VirusScanData> scanHistoryList() {
        ...
        try {
            scannedResultsAll = CommonUtil.getScanResultsInPreference(this, Constant.PREF_KEY_ALL_SCANNED_VIRUS_RESULT_ALL);
    ...
    private void refreshResultData(String pacakageName) {
//        updateDetectCount();
        resetScanResult();
        scanHistoryList();
