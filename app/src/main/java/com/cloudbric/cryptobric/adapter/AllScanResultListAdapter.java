...
public class AllScanResultListAdapter extends RecyclerView.Adapter<AllScanResultListAdapter.ViewHolder> {
    Context context;
    List<VirusScanData> mScanDataList = new ArrayList<>();
    private PackageManager mPacakageManager;
    private final static String TAG = "AllScanResultListAdapter";
    private int mDetectedCount;
    static int TYPE_HEADER = 0;
    static int TYPE_CELL = 1;


    public AllScanResultListAdapter(Context c, List<VirusScanData> scanDataList, int detectedCount) {
        this.context = c;
        this.mScanDataList = scanDataList;
...
//                packageEventListener.onPackgeDeleted(vScanData.getPackageName());
    ...
    public void setData(List<VirusScanData> scanDataList, int detectedCount) {
        this.mScanDataList = scanDataList;
